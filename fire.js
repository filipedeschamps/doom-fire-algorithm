...
const ENGINE_DEFAULT = ENGINE_CANVAS
...
function start(context) {
  ...
  setInterval(calculateFirePropagation(context), 50)
}
...
function calculateFirePropagation(context) {
  return function () {
...
function renderFire(context) {
  switch (context.engine) {
    case ENGINE_DOM_TABLE:
      domTableEngine()
      break
